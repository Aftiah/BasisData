...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 27, 2021 at 04:46 AM
...
INSERT INTO `karyawan` (`id`, `nik`, `nama_lengkap`, `alamat_rumah`, `handphone`, `email`, `tanggal_masuk`, `pengguna_id`) VALUES
(1, '001', 'Admin', 'Kota Banjarbaru', '08112011', 'admin@mail.com', '2011-01-01', 1),
(2, '002', 'Tes User', 'Kota Banjarmasin', '08112012', 'user@mail.com', '2012-02-02', 2),
(3, '003', 'John Doe', 'Kabupaten Banjar', '08112013', 'john@mail.com', '2013-03-03', 3),
